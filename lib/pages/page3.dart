                    ...
                    children: [
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 26.0, bottom: 26),
                            child: Text(
                                'May 4 - May 10',
                                style: TextStyle(
                                fontSize: 12.0,
                      ...
                      new Spacer(),
                      Icon(Icons.arrow_back_ios, color: Colors.black87, size: 25,),
                      SizedBox(width: 25,),
                      Icon(Icons.arrow_forward_ios, color: Colors.black45, size: 25,),
                      SizedBox(width: 10,)
                    ],
                  ),
                ),
